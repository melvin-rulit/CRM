...
<div class="row">
    <div class="col-lg-12">
      ...
      <b-form-radio @change="sendlpr" v-model="lpr" name="some-radios" value="A">Option A</b-form-radio>
      <b-form-radio @change="sendlpr" v-model="lpr" name="some-radios" value="B">Option B</b-form-radio>
      <b-form-radio @change="sendlpr" v-model="lpr" name="some-radios" value="C">Option C</b-form-radio>
...
Vue.use(Loading);
    ...
    export default {
        ...
        methods: {
            ...
            sendlpr(){
                axios.post('api/v2/666', {lpr: this.lpr})
            },
