...
<div class="row flex-nowrap test">
    <div v-if="halls" v-for="hall in halls" class="col-3 col-lg-3">
        <div class="card">
            <div class="card-body">
            	<a href="#" @click.prevent="null">{{ hall.name }}</a> 
                ...
                <div class="card card-sm mb-2" v-for="(curr, index) in 21" v-if="index + 1 >= n">
                    <div class="card-body">
                        <div class="row align-items-center">
					        ...
					        <b-form-select v-model="programm" :options="programms" class="m-3"></b-form-select>
					        <b-form-select v-model="timeselect" :options="time" class="m-3"></b-form-select>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <table class="table table-bordered datatable datatable-User table-collection">
                    <tbody>
                        ...
                        <tr>
                            <td class="bg-primary text-white">11:00 - Зирка лева<span class="col-auto"><i class="fe fe-plus"></i></span></td>
                        </tr>
  ...
  export default {
    ...
    methods: {
    	...
    	showCalendar(hall) {
			...
			// alert('Рассписание программ обучения ' + hall)
    	},
